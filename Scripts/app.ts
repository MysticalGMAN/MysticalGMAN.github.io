...
Course: WEBD6201
Description: This is the app.ts file for our Web Development Work including new Additions and changes for our
Assignment 3. Additionally, we have added a new function called AddTaskListLink() to add the task-list page into our
navbar.
*/
(function()
{
     ...
     */
     ...
     function AddTaskListLink(){
         if (sessionStorage.getItem("user")) {
             ...
             let liTag = $("ul>li")[4];
             liTag.insertAdjacentHTML("afterend", `<li class="nav-item">
                <a id="taskList" class="nav-link" data="task-list">
                <i class="fas fa-tasks"></i> Task List</a></li>`);
